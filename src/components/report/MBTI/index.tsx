            ...
            <div className="page-box">
                ...
                <div className="result-detail">
                    ...
                    <div className="result-detail-item">
                        ...
                        <div className="result-detail-box">
                            <p><em>感觉(S):{resultDetail?.examTemplateArr?.[0] && resultDetail?.scoreDetail?.S?.score}</em>倾向于当前发生的事，关注由五官感觉获取的具体信息。</p>
                            <p><em>直觉(N):{resultDetail?.examTemplateArr?.[0] && resultDetail?.scoreDetail?.N?.score}</em>倾向于未来可能的和潜在的事，关注事物的整体和发展变化趋势。</p>
                        </div>
                    </div>
                    {/* <div className="result-detail-item">
