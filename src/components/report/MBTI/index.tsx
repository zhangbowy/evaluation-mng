        ...
        <div id="Pdf_Body" className="pdfdetail-layout" style={childStyle}>
            ...
            <div className="page-box">
                ...
                <div className="result-detail">
                    ...
                    <div className="result-detail-item">
                        <p className="title">信息接收（{resultDetail?.examTemplateArr?.length && resultDetail?.examTemplateArr?.[1]}:{resultDetail?.examTemplateArr?.length && (MBTISimpel as any)[resultDetail?.examTemplateArr?.[1]]}）</p>
                        <div className="result-detail-box">
                    ...
                    <div className="result-detail-item">
                        <p className="title">信息处理（{resultDetail?.examTemplateArr?.length && resultDetail?.examTemplateArr?.[2]}:{resultDetail?.examTemplateArr?.length && (MBTISimpel as any)[resultDetail?.examTemplateArr?.[2]]}）</p>
                        <div className="result-detail-box">
                    ...
                    <div className="result-detail-item">
                        <p className="title">行动方式（{resultDetail?.examTemplateArr?.length && resultDetail?.examTemplateArr?.[3]}:{resultDetail?.examTemplateArr?.length && (MBTISimpel as any)[resultDetail?.examTemplateArr?.[3]]}）</p>
                        <div className="result-detail-box">
