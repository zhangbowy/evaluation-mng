...
const CareerAnchor = forwardRef((props: { resultList: IResult }, ref) => {
    const qcp_c_labelBg1 =
        'https://qzz-static.forwe.store/evaluation-web/imgs/qcp_web_image/qcp_c_labelbg1.png';
    const qcp_c_labelBg2 =
        'https://qzz-static.forwe.store/evaluation-web/imgs/qcp_web_image/qcp_c_labelbg2.png';
